                                            ...
                                            <ul class="megamenu">
                                                ...
                                                <li>
                                                    <div class="banner-fixed menu-banner menu-banner2">
                                                        <figure>
                                                            <img src="{{ asset('assets\images\menu\banner-2.jpg') }}" alt="Menu Banner" width="235" height="347">
                                                        </figure>
                                            ...
                                            <ul class="megamenu">
                                                ...
                                                <li>
                                                    <div class="menu-banner banner-fixed menu-banner3">
                                                        <figure>
                                                            <img src="{{ asset('assets\images\menu\banner-3.jpg') }}" alt="Menu Banner" width="235" height="461">
                                                        </figure>
                                                        <div class="banner-content">
                                            ...
                                            <ul class="megamenu">
                                                ...
                                                <li>
                                                    <div class="menu-banner banner-fixed menu-banner4">
                                                        <figure>
                                                            <img src="{{ asset('assets\images\menu\banner-4.jpg') }}" alt="Menu Banner" width="235" height="433">
                                                        </figure>
                                                        <div class="banner-content">
                                                ...
                                                <li class="row">
                                                    <div class="col-6">
                                                        <div class="banner banner-fixed menu-banner5 br-xs">
                                                            <figure>
                                                                <img src="{{ asset('assets\images\menu\banner-5.jpg') }}" alt="Banner" width="410" height="123" style="background-color: #D2D2D2;">
                                                            </figure>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="banner banner-fixed menu-banner5 br-xs">
                                                            <figure>
                                                                <img src="{{ asset('assets\images\menu\banner-6.jpg') }}" alt="Banner" width="410" height="123" style="background-color: #9F9888;">
                                                            </figure>
